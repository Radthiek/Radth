  ...
  return channel.send(`**ولكم نورت السيرفر** ${member} `) 
             ...
             bot.on('message', message => {
                if(message.content === prefix + "invite") {
                    ...
                    .setURL("https://discordapp.com/oauth2/authorize?bot_id=506882405165170697&scope=bot&permissions=2146958591");
...
.addField(' السيرفرات🌐',`[${bot.guilds.size}]  `)
.addField(' الاعضاء👥 ',` [${bot.users.size}] `)
.addField('الرومات📚 ',`[${bot.channels.size}]`) 
...
bot.on('message', message => { // RadThiek
