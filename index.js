...
bot.on("ready", async () => {
  ...
  bot.user.setActivity("| RadBot - [.help]", {type: "WATCHING"});
...
bot.on('guildCreate', guild => {
  ...
  .setDescription(`**شكراً لك لإضافه البوت الى سيرفرك**`)
      ...
      bot.on('guildMemberAdd', member => {
        ...
        .setColor('GREEN')
        .setFooter('======= نــتــمــنــآ لــكــم آســتــمـــتــآع =======')
  ...
  return channel.send(`**ولكم نورت السيرفر** ${member} `) 
             ...
             bot.on('message', message => {
                if(message.content === prefix + "invite") {
                    ...
                    embed.setTitle("**:point_right:  Invite RadBot !**")
                    .setURL("https://discordapp.com/oauth2/authorize?client_id=506882405165170697&scope=bot&permissions=2146958591");
